...
const SendParcel = () => {
    ...
    const regions = [...new Set(regionsDublicate)];
            ...
            <form onSubmit={handleSubmit(handleSendParcel)} className='mt-12 p-4 text-black'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-12 my-8'>
                    ...
                    <fieldset className="fieldset">
                        ...
                        <input type="number" {...register('parcelWeight')} className="input w-full" placeholder="Parcel Weoght" />
                    </fieldset>
                </div>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-12'>
                    ...
                    <fieldset className="fieldset">
                        ...
                        <input type="text" {...register('reeiverEmail')} className="input w-full" placeholder="Receiver Email" />
                ...
                <input type="submit" className='btn btn-primary text-black mt-8' value="send percel" />
            </form>
        </div>
    );
};
